using StandardUpdaterLib.Downloaders;
using StandardUpdaterLib.ExceptionHandler;
using StandardUpdaterLib.ExceptionHandler.Exceptions;
using StandardUpdaterLib.FileSystem;
using StandardUpdaterLib.Hash;
using StandardUpdaterLib.Resources;
using StandardUpdaterLib.Resources.Configs;
...
namespace StandardUpdaterLib.Engine {
    ...
    public class PatcherEngine : IPatcherEngine {
        ...
        private static IDisplayError ErrorDisplay;
        ...
        /// </summary>
        public PatcherEngine(BackgroundWorker bw, IDisplayError errorDisplay)
        {
            handler = new Handler(errorDisplay);
